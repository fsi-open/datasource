...
/**
 * Class contains method called at GetResult and BuildView events.
 *
 * Two kinds of events are in the same class, because both need method to calculate next priority.
 */
class GetResultAndBuildView implements EventSubscriberInterface
{
    /**
     * @var int
     */

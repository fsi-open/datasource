...
class DoctrineDriverBasicTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $qb = $this->createMock('Doctrine\ORM\QueryBuilder', [], [$em]);
    ...
    public function testGetResult()
    {
        ...
        for ($x = 0; $x < 6; $x++) {
            $field = $this->createMock('FSi\Component\DataSource\Driver\Doctrine\DoctrineAbstractField');
    ...
    {
        $fields = [$this->createMock('FSi\Component\DataSource\Field\FieldTypeInterface')];
